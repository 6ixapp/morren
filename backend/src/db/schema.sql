...
-- Run this file to create all tables with proper constraints

-- Enable UUID extension
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";
CREATE EXTENSION IF NOT EXISTS "pgcrypto";

-- Users table (includes auth)
...
DROP TRIGGER IF EXISTS update_shipping_bids_updated_at ON shipping_bids;
